...
# объединяе два list в list tuple (zip(first, second)),
# на каждом шаге итерации производим вычисления (len(x[0]) - len(x[1])
...
# генерируем цикл на range(len(first)) итераций,
# затем сравниваем (len(first[index]) == len(second[index])
